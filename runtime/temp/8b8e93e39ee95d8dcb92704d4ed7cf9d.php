<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/yusuzhou.youacloud.com/application/user/view/admin/publics/signin.html";i:1519568147;}*/ ?>
<!DOCTYPE html>
...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="zh"> <!--<![endif]-->
    ...
    <body>
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                        <div class="push-30-t push-50 animated fadeIn">
                            ...
                            <div class="text-center">
                                <img src="/public/uploads/images/20180112/2a582ec3333c281b5ef3539025c4bc7b.png" alt="玉蘇周">
        ...
        <div class="pulldown push-30-t text-center animated fadeInUp">
            <small class="text-muted"><span class="js-year-copy"></span> &copy; 玉蘇周版权所有</small>
        </div>
        <!-- END Login Footer -->
