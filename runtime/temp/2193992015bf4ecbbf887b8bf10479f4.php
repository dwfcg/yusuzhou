                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="toolbar-btn-action">
                                    ...
                                    <div class="form-inline" style="display: inline-block;">
                                        ...
                                        <select class="js-select2 form-control select-change select-search" data-width="auto" id="select-<?php echo $item['name']; ?>">
